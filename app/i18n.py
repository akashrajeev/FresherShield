...
LABELS = {
    "hi": {
        ...
        "pay_role": "सैलरी ({stated}) {role} में फ्रेशर्स की आम सैलरी ({range}) से बहुत ज़्यादा है",
        ...
        "news_fraud": "{n} समाचार रिपोर्ट इस नाम को नौकरी धोखाधड़ी से जोड़ती हैं",
        "news_impersonation": "समाचारों में इस कंपनी के नाम से नकली ऑफ़र की चेतावनी है",
    },
    "ml": {
        ...
        "pay_role": "ശമ്പളം ({stated}) {role} ജോലികളിൽ ഫ്രഷർമാർക്ക് സാധാരണ ലഭിക്കുന്നതിനേക്കാൾ ({range}) വളരെ കൂടുതലാണ്",
        ...
        "news_fraud": "{n} വാർത്താ റിപ്പോർട്ടുകൾ ഈ പേരിനെ തൊഴിൽ തട്ടിപ്പുമായി ബന്ധിപ്പിക്കുന്നു",
        "news_impersonation": "ഈ കമ്പനിയുടെ പേരിലുള്ള വ്യാജ ഓഫറുകളെക്കുറിച്ച് വാർത്തകൾ മുന്നറിയിപ്പ് നൽകുന്നു",
    },
}
...
DETAILS = {
    "hi": {
        ...
        "news_fraud": "गिरफ़्तारी या शिकायतों की खबरें फ़ोरम पोस्ट से ज़्यादा मज़बूत सबूत हैं। हेडलाइन पढ़ें: कुछ ठगों के बारे में हो सकती हैं।",
        "news_impersonation": "यहाँ आमतौर पर कंपनी खुद पीड़ित होती है। सिर्फ़ उसके आधिकारिक करियर पेज से अप्लाई करें।",
    },
    "ml": {
        ...
        "news_fraud": "അറസ്റ്റുകളെക്കുറിച്ചോ പരാതികളെക്കുറിച്ചോ ഉള്ള വാർത്തകൾ ഫോറം പോസ്റ്റുകളേക്കാൾ ശക്തമായ തെളിവാണ്. തലക്കെട്ടുകൾ വായിക്കുക: ചിലത് ആൾമാറാട്ടക്കാരെക്കുറിച്ചാകാം.",
        "news_impersonation": "ഇവിടെ സാധാരണയായി കമ്പനി തന്നെയാണ് ഇര. അതിന്റെ ഔദ്യോഗിക കരിയർ പേജ് വഴി മാത്രം അപേക്ഷിക്കുക.",
    },
}
